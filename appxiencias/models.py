...
class Audios(models.Model):
    id = models.IntegerField(primary_key=True)  # AutoField?
    audio1 = models.FileField(upload_to='files')
    audio2 = models.FileField(upload_to='files')
...
class AuthUser(models.Model):
    ...
    cliente = models.ForeignKey('Clientes', db_column='cliente', blank=True, null=True)
...
class Campaniasms(models.Model):
    id = models.IntegerField(primary_key=True)  # AutoField?
    name = models.CharField(max_length=100, blank=True)
    mensaje = models.CharField(max_length=100, blank=True)
    user = models.ForeignKey(AuthUser, db_column='user', blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'campaniasms'
...
class Clientes(models.Model):
    id = models.IntegerField(primary_key=True)  # AutoField?
    database = models.ForeignKey('Databases', db_column='database', blank=True, null=True)
    name = models.CharField(max_length=100, blank=True)
    capa = models.IntegerField(blank=True, null=True)
...
class Contactos(models.Model):
    id = models.IntegerField(primary_key=True)  # AutoField?
    grupo = models.ForeignKey('Grupo', db_column='grupo', blank=True, null=True)
...
class DBlaster(models.Model):
    ...
    lote = models.ForeignKey('Lote', db_column='lote', blank=True, null=True)
...
class Externalapp(models.Model):
    ...
    servicio = models.ForeignKey('Servicio', db_column='servicio', blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'externalapp'


class Grupo(models.Model):
    id = models.IntegerField(primary_key=True)  # AutoField?
    name = models.CharField(max_length=100, blank=True)
    excel = models.ForeignKey(Excell, db_column='excel', blank=True, null=True)
    user = models.ForeignKey(AuthUser, db_column='user', blank=True, null=True)
...
class Lote(models.Model):
    ...
    servicio = models.ForeignKey('Servicio', db_column='servicio', blank=True, null=True)
    user = models.ForeignKey(AuthUser, db_column='user', blank=True, null=True)
    campania = models.ForeignKey('Campaniasms', db_column='campania', blank=True, null=True)
