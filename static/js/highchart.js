...
(function() {
    ...
    var jb = E.adapterRun,
        ...
        cb = E.stop;
    S = {
        colors: "#46568B,#434348,#90ed7d,#f7a35c,#8085e9,#f15c80,#e4d354,#2b908f,#f45b5b,#91e8e1".split(","),
    ...
    Aa.prototype = {
        ...
        getStyle: function(a) {
            return this.style = t({
                fontFamily: '"Open Sans", "Lucida Sans Unicode", Arial, Helvetica, sans-serif',
                fontSize: "12px"
            }, a)
        },
        isHidden: function() {
    ...
    Mb.prototype = {
        ...
        refresh: function(a, b) {
            ...
            j === !1 ? this.hide() : (this.isHidden && (cb(d), d.attr("opacity", 1).show()), d.attr({
                text: j
            }), m = e.borderColor || a.color || i.color || "#46568B", d.attr({
                stroke: m
            }), this.updatePosition({
                plotX: f,
                plotY: g,
            ...
            if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                if (Da(F) === 0 || this.verifyDataLabelOverflow(F)) this.placeDataLabels(), t && g && o(this.points, function(b) {
                    ...
                    if ((x = b.dataLabel) && x._pos && b.visible) E = x._attr.visibility, C = x.connX, B = x.connY, k = m ? ["M", C + (y[6] === "left" ? 5 : -5), B, "C", C, B, 2 * y[2] - y[4], 2 * y[3] - y[5], y[2], y[3], "L", y[4], y[5]] : ["M", C + (y[6] === "left" ? 5 : -5), B, "L",
                        ...
                        "stroke-width": g,
                        stroke: e.connectorColor || b.color || "#46568B",
                        visibility: E
